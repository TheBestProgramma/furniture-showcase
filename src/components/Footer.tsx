        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-xl">FurniturePro</h3>
            </div>
            <p className="text-secondary-300 mb-6 max-w-md">
              Quality furniture for your home at affordable prices. We bring comfort, style, and durability to every piece we create.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 text-secondary-300">
              <div className="flex items-center gap-2">
                ...
                <span>info@furniturepro.com</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-secondary-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-secondary-300 text-sm">
              &copy; 2024 FurniturePro. All rights reserved.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <Link href="/shipping" className="text-secondary-300 hover:text-white text-sm transition-colors">
                Shipping Info
              </Link>
            </div>
          </div>
